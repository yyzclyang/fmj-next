...
export function SettingsDialog({
  ...
  return (
    ...
    >
      <section
        className="w-[min(100%,356px)] rounded-xl border-2 border-[#b4893f] bg-[linear-gradient(135deg,rgba(255,238,174,0.08),transparent_22%),radial-gradient(circle_at_28%_18%,rgba(255,255,255,0.08),transparent_18%),linear-gradient(180deg,#1a1b18_0%,#10110f_48%,#1b1b17_100%)] pb-[18px] text-[#ead6a4] shadow-[0_18px_50px_rgba(0,0,0,0.62),inset_0_0_0_1px_rgba(255,232,163,0.13)]"
        role="dialog"
        aria-modal="true"
      ...
      >
        ...
        <div className="p-[18px_18px_8px]">
          <div className="flex items-center justify-between gap-3 text-[19px] font-extrabold text-[#d7b866]">
            <span>速度</span>
            <strong className="min-w-[58px] rounded-[7px] border border-[#b4893f] bg-black/35 px-[7px] py-[5px] text-center text-base text-[#f1dfb5]">
              {speedText}x
            </strong>
          </div>
          <input
            className="my-[17px] mb-[7px] w-full accent-[#c79b42]"
            name="speed"
            type="range"
            min="0.5"
            max="3"
