...
export function SwitchConfirmDialog({ onCancel, onConfirm }: SwitchConfirmDialogProps) {
  return (
    ...
    >
      <section
        className="w-92 rounded-xl border-2 border-[#b4893f] bg-[linear-gradient(135deg,rgba(255,238,174,0.08),transparent_22%),radial-gradient(circle_at_28%_18%,rgba(255,255,255,0.08),transparent_18%),linear-gradient(180deg,#1a1b18_0%,#10110f_48%,#1b1b17_100%)] pb-6 text-[#ead6a4] shadow-[0_18px_50px_rgba(0,0,0,0.62),inset_0_0_0_1px_rgba(255,232,163,0.13)] max-[720px]:w-[min(100%,314px)]"
        role="dialog"
        aria-modal="true"
        aria-labelledby="switch-confirm-title"
        onClick={event => event.stopPropagation()}
      >
        <header className="flex min-h-16 items-center justify-center border-b border-[rgba(183,148,83,0.2)] px-5">
          <h2
        ...
        <p className="m-6 text-center text-[17px] leading-[1.7] font-bold text-[#f3e6c6]">
          切换游戏会丢失当前进度，
          <br />
          是否继续？
        </p>
